    ...
    if (empty($username)) {
        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                $stmt = $conn_user->prepare('INSERT INTO users (username, email, password, role, created_at) VALUES (?, ?, ?, ?, NOW())');
                $stmt->execute([$username, $email, $hashed_password, $role]);
                $success = "Tạo tài khoản user thành công!";
            }
    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <button type="submit" class="btn-add-user">
                <span class="btn-icon">+</span> Tạo User
            </button>
